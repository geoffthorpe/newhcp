...
if __name__ == '__main__':
    ...
    unseal_help = 'Unseal an attestation-returned asset'
    unseal_epilog = """
    The 'unseal' subcommand interacts with the host's TPM to unseal an asset that was
    returned from the Attestation Service.
    """

...
#
# For more detail on how "scope" works, see HcpJsonScope.py
#
# NB, the simpler form of "scope", when it is just a string, is equivalent to a
# single "import". Ie.
#     "scope": ".foo"
# is equivalent to;
...
from HcpJsonPath import valid_path, extract_path, HcpJsonPathError

...
cp /crud/hcp_uml_guest_$VM_FLAVOR.img /myvm.img
...
# HACK: NFSv4 over NAT is complicated by the concept of server callbacks. The
# client VM needs to know its container's IP address when mounting.
